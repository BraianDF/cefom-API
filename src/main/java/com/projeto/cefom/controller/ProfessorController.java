...
import com.projeto.cefom.service.ProfessorService;
...
public class ProfessorController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProfessorResponseDTO>> listar(@PageableDefault(page = 0, size = 10, sort = "nome", direction = Sort.Direction.ASC) Pageable pageable, @RequestParam(defaultValue = "") String nome) {
