...
public class DadosSocialController {
    ...
    public ResponseEntity<Page<DadosSocialListarResponseDTO>> listar(@PathVariable Integer idAdolescente, @PageableDefault(page = 0, size = 10, sort = "dataInicio", direction = Sort.Direction.DESC) Pageable pageable) {
